        ...
        >
          ...
          <div className="p-8 flex flex-col items-center text-center">
            {!isOpened ? (
              ...
              >
                <div className="text-6xl mb-4">{festival.giftIcon}</div>
                <h2 className="text-3xl font-serif font-bold mb-4" style={{ color: festival.primary }}>
                  {festival.name !== "Default" ? festival.name : "Welcome!"}
                </h2>
                <p className="text-lg font-medium text-gray-800 mb-6 italic">
                  "{festival.message}"
                </p>
                
                <div className="w-full p-6 rounded-2xl bg-gray-50 border-2 border-dashed border-gray-300 mb-6">
                  <p className="text-sm text-gray-500 uppercase tracking-widest mb-1">Use Code</p>
                  <p className="text-3xl font-bold tracking-widest" style={{ color: festival.primary }}>
                    FESTIVAL10
                  </p>
                  <p className="text-sm text-gray-500 mt-2">Get 10% OFF on your first purchase</p>
                </div>
